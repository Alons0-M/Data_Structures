...
public class WBLeftistHeap<T> implements Heap<T> {
  ...
  public int size() {
    //throw new UnsupportedOperationException("Not implemented yet");
    return weight(root); //root.weight (root could be empty)
  }
  ...
  public void clear() {
    //throw new UnsupportedOperationException("Not implemented yet");
    root = null; //weight not needed because other methods a null root return weight 0
  }
