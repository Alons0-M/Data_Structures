...
public class MaxiphobicHeap<T> implements Heap<T> {
  ...
  public void insert(T element) {
    //throw new UnsupportedOperationException("Not implemented yet");
    Node<T> singleton = new MaxiphobicHeap.Node<>(element);
    //Node<T> singleton = new Node<>(element); with a method
  ...
  private Node<T> merge(Node<T> node1, Node<T> node2) {
    ...
    //node1 has minimun element as root
    Node<T> tree1 = node1.left;
    Node<T> tree2 = node1.right;
    Node<T> tree3 = node2;
    //swap trees to set tree1 as the larguest
    ...
    //weight(tree1) is the larguest
    node1.left = tree1; //larguest tree
    node1.right = merge(tree2, tree3); //merge smallest ones
    //set new weight
  ...
  public T minimum() {
    //throw new UnsupportedOperationException("Not implemented yet");
    if (isEmpty()) {
      throw new EmptyHeapException("minimum on empty tree");
    }
    return root.element;
  }
  ...
  public void deleteMinimum() {
    //throw new UnsupportedOperationException("Not implemented yet");
    if (isEmpty()) {
      throw new EmptyHeapException("deleteMinimum on empty tree");
    }
