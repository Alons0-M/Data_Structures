...
public class ArrayStack<T> extends AbstractStack<T> implements Stack<T> {
  ...
  public static <T> ArrayStack<T> empty() {
    ...
    ArrayStack<T> empty = new ArrayStack<>();
    empty.elements = (T[]) new Object[DEFAULT_INITIAL_CAPACITY];
    empty.size = 0;
    return empty;
  }
  ...
  public static <T> ArrayStack<T> withCapacity(int initialCapacity) {
    ...
    ArrayStack<T> copy = new ArrayStack<>();
    copy.elements = (T[]) new Object[initialCapacity];
    copy.size = 0;
    return copy;
  }
  ...
  public static <T> ArrayStack<T> of(T... elements) {
    //throw new UnsupportedOperationException("Not implemented yet");
    var stack = new ArrayStack(elements.length);
    for(var e : elements) {
      stack.push(e);
    }
    return stack;
  ...
  public static <T> ArrayStack<T> copyOf(ArrayStack<T> that) {
    //throw new UnsupportedOperationException("Not implemented yet");
    ArrayStack<T> copy = new ArrayStack<>();
    copy.elements = (T[]) new Object[that.elements.length];
    copy.size = 0;
    return copy;
  }
  ...
  public static <T> ArrayStack<T> copyOf(Stack<T> that) {
    //throw new UnsupportedOperationException("Not implemented yet");
    ArrayStack<T> copy = new ArrayStack<>();
    copy.elements = (T[]) new Object[that.size()];
    copy.size = 0;
    return copy;
  }
  ...
  public T top() {
    //throw new UnsupportedOperationException("Not implemented yet");
    if(isEmpty()) {
      throw new EmptyStackException("no top");
    }else {
  ...
  public void pop() {
    //throw new UnsupportedOperationException("Not implemented yet");
    if(isEmpty()) {
      throw new EmptyStackException("can't pop");
    }
