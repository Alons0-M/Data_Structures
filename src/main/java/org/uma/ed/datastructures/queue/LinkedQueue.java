...
public class LinkedQueue<T> extends AbstractQueue<T> implements Queue<T> {
  ...
  public static <T> LinkedQueue<T> of(T... elements) {
    LinkedQueue<T> queue = LinkedQueue.empty(); //new LinkedQueue<>()
  ...
  public static <T> LinkedQueue<T> copyOf(LinkedQueue<T> that) {
    ...
    LinkedQueue<T> copy = LinkedQueue.empty(); //best than new LinkedQueue<>()
  ...
  public void enqueue(T element) {
    ...
    if (isEmpty()) { //if we put an element in an empty queue
      first = node;
    } else {
      last.next = node;
    }
